      ...
      <div className="flex w-full bg-black">
        ...
        <div className="w-[35%]">
            <form  onSubmit={onSubmit} className="border-slate-400 border-[0.3px] rounded-[10px] my-[20px] mx-[40px] w-[27.5rem]">
              ...
              <button  onClick={toggleModal} type="reset" className="bg-white text-black rounded-[35px] font-bold w-[25rem] h-[3rem] text-center m-[12px]">Create account</button>
              <Form  isOpen={!openModal} toggle={toggleModal} />
